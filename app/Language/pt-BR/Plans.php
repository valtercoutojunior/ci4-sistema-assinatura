...
return [
    ...
    'title_index_archive'           => 'Listando Planos Arquivados',
    ...
    'breadcrumb_index'          => 'Listar Planos',
    'breadcrumb_index_archive'  => 'Planos Arquivados',
    ...
    'name'        => [
        ...
        'max_length'    => 'Informe no maximo 90 caractéres',
    ...
    'value' => [
        'required'      => 'Infome o preço do plano',
    ],
    'description' => [
        'required'      => 'Informe uma descrição para o plano',
    ],
];
