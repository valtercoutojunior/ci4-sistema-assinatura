...
return [
    ...
    'profile' => [
        'name' => [
            ...
            'min_length'    => 'O nome deve ter no minímo 3 caractéres',
            'max_length'    => 'O nome deve ter no máximo 25 caractéres',
        ],
        'last_name' => [
            'required'      => 'Informe um sobrenome',
            'min_length'    => 'O sobrenome deve ter no minímo 3 caractéres',
            'max_length'    => 'O sobrenome deve ter no máximo 95 caractéres',
        ],
        'cpf' => [
        ...
        'phone' => [
            ...
            'exact_length'  => 'O telefone deve ter exatamente 15 caractéres',
    ...
    'access' => [
        'password' => [
            ...
            'min_length'        => 'A nova senha deve ter pelo menos 8 caractéres',
        ],
        'password_confirmation' => [
            'matches'    => 'A nova senha e a confirmação de senha não coicidem',
        ],
    ],
