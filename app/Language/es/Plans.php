...
return [
    ...
    'name'        => [
        ...
        'min_length'    => 'Introduzca al menos 3 caracteres',
        'max_length'    => 'Introduzca un máximo de 90 caracteres',
    ...
    'value' => [
        'required'      => 'Informar el precio del plan',
    ],
    'description' => [
        'required'      => 'Ingrese una descripción para el plan',
    ],
];
