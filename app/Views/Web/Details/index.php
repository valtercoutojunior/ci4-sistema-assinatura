                    ...
                    <div class="product-meta">
                        <ul class="list-inline">
                            <li class="list-inline-item">
                                ...
                                Por<a href="<?php echo route_to('adverts.user', $advert->username); ?>">
                                    <?php echo $advert->name ?? $advert->username; ?>
                                </a>
                            </li>
                            <li class="list-inline-item">
                                <i class="fa fa-folder-open-o"></i>
                                Categoria<a href="<?php echo route_to('adverts.category', $advert->category_slug); ?>">
                                    <?php echo $advert->category; ?>
                                </a>
                            </li>
                            <li class="list-inline-item">
                                <i class="fa fa-location-arrow"></i>
                                Onde <a title="Ver anúncios na Cidade de <?php echo $advert->city; ?>" href="<?php echo route_to('adverts.category.city', $advert->category_slug, $advert->city_slug); ?>">
