...
<?= $this->include('Web/Home/Scripts/_viacep'); ?>
<script>
...
<?php if (env('CI_ENVIRONMENT') === 'development') : ?>
    <?= $this->include('Web/Home/Scripts/_development'); ?>
<?php else : ?>
    <?= $this->include('Web/Home/Scripts/_production'); ?>
<?php endif ?>
...
<script>
    $gn.ready(function(checkout) {
        $('[name=card_brand]').on('change', function() {
            ...
            if (card_brand) {
                validate_card(card_brand);
            }
        });

        function validate_card(card_brand) {
