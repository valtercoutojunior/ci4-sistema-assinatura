...
<?= $this->section('title') ?>
<?= lang('Categories.title_index_archive'); ?>
<?= $this->endSection() ?>
...
<div class="pagetitle">
    <div class="container">
        <h1 class="mb-2"><?= lang('Categories.title_index_archive'); ?></h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?= route_to('manager'); ?>">Home</a></li>
                <li class="breadcrumb-item active"><?= lang('Categories.title_index_archive'); ?></li>
            </ol>
        </nav>
    </div>
</div><!-- End Page Title -->
            ...
            <div class="card-header">
                <div class="d-flex flex-column flex-sm-row px-2 py-0 ">
                    ...
                    <div class="p-2 flex-fill text-sm-end">
                        <a href="<?= route_to('categories') ?>" class="btn btn-secondary my-1">
...
<?= $this->include('Manager/Categories/Scripts/_datatable_all_archived'); ?>
<?= $this->include('Manager/Categories/Scripts/_recover_category'); ?>
<?= $this->include('Manager/Categories/Scripts/_delete_category'); ?>
<script>
