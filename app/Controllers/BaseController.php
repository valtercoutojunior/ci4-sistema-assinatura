...
abstract class BaseController extends Controller
{
     ...
     */
    protected $helpers = [
        'form', 'number', 'superadmin',  'gerencianet', 'text', 'adverts',
    ];
    ...
    private function setUpLanguageOptions($request)
    {
        ...
        /**
         * Cria o array de linguagens suportadas 
         * caso queira mais linguagens é aqui de devem ser add
         */
        $urls = [
        ...
        $language = match ($this->locale) {
            ...
            'es'    => img('language/espanha.png') . ' Español',
